...
import { createMatchState, prepareServe, performServe, updateMatch } from "../js/game.js?v=20260813-outfit-lossless-v21";
import { AI_OPPONENTS, ARENAS, ATHLETES } from "../js/data.js?v=20260813-outfit-lossless-v21";

...
import { createMatchState, hitBall, updateMatch } from "../js/game.js?v=20260813-signature-outfits-v24";
import { AI_OPPONENTS, ARENAS, ATHLETES, BALANCE, COURT } from "../js/data.js?v=20260813-signature-outfits-v24";

...
import { createMatchState, hitBall, updateMatch } from "../js/game.js?v=20260814-feedback-v38";
import { AI_OPPONENTS, ARENAS, ATHLETES, COURT } from "../js/data.js?v=20260814-feedback-v38";
...
// `i18n.js` e `i18n.js?v=20260814-feedback-v38` sono due istanze distinte, quindi setLang su una

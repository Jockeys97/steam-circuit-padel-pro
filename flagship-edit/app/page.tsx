    ...
    <main className="studio-shell">
      ...
      <div className="project-frame" id="top">
        ...
        <section className="workbench">
          ...
          <section className="outcome-strip"><span>BUSINESS OUTCOME</span><p>{executionError || scenario.outcome}</p><div className={scenario.id === "continuity" ? "result flagship" : executionError ? "result error" : runStep === scenario.steps.length - 1 ? "result complete" : "result"}>{scenario.id === "continuity" ? "◆ Flagship system" : executionError ? "× n8n unavailable" : runStep === scenario.steps.length - 1 ? "✓ Live run completed" : calling ? "● Calling n8n" : running ? "● Rendering trace" : "○ Not executed"}</div></section>
